    ...
    <div className="fixed inset-0 z-50 flex h-full w-full bg-gray-50 overflow-hidden font-sans">
      ...
      >
        ...
        <div className="p-4 border-t border-gray-200">
          <button className="flex w-full items-center px-4 py-3 text-sm font-medium text-gray-600 rounded-lg hover:bg-red-50 hover:text-red-600 transition-colors group">
