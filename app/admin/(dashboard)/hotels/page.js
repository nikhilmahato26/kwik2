...
import { deleteHotel } from "@/app/admin/actions";
                    ...
                    <tr key={hotel.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <div className="flex items-center justify-end gap-3">
                          <Link href={`/admin/hotels/${hotel.id}/edit`} className="text-gray-400 hover:text-indigo-600 transition-colors">
                            <Edit2 className="size-4" />
                          </Link>
                          <DeleteButton
                            action={deleteHotel}
                            id={hotel.id}
                            confirmMessage={`Delete "${hotel.title}"? This cannot be undone.`}
                          />
                        </div>
                      </td>
                    </tr>
